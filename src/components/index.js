...
import MenuBar from "./common/header/menu-bar/menu-bar"
import ProductMenu from "./common/header/product-menu/product-menu"
import TopBar from "./common/header/top-bar/top-bar"
