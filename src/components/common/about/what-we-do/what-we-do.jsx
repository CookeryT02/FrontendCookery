      ...
      <Row className="container-fluid">
        ...
        <Col lg={8}>
          <p>At Cookery Tech Industrial Kitchen Equipment, we specialize in
            ...
            establishments.</p>
          <p>Our company is committed to delivering top-notch
          ...
          <p>We work closely with renowned
            ...
            customer service.</p>
          <p>Our knowledgeable team of experts is ready to
            ...
            reliable after-sales support to ensure your complete satisfaction.</p>
          <p>At Cookery Tech Industrial Kitchen Equipment, we are passionate
            about helping our customers create culinary masterpieces and achieve
            their business goals.</p>
          <p>
            We take pride in being a trusted partner in
